...
`NanoTemplate.render(template, dataSource = null, fetchOption = {}, targetElementId = 'app', viewPath = '/page/', templateExtension = '.html')`
...
- `fetchOption`: options for `dataSource` if it is a remote api url
